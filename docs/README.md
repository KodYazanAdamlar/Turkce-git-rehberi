...
> [](https://btt.community/t/turkce-git-kullanim-rehberi/25863#p-36820-adm-1-terminali-an-1)Adım 1: Terminali Açın Linux sistemde terminali açın. Terminali açmak için genellikle Ctrl + Alt + T tuşlarına basabilir veya uygulama menüsünden terminal simgesini seçebilirsiniz. [](https://btt.community/t/turkce-git-kullanim-rehberi/25863#p-36820-adm-2-gitin-kurulumu-2)Adım 2: Git’in Kurulumu Ubuntu / Debian: sudo apt update sudo apt install git Fedora: sudo dnf install git-all git-all: Git’in paketlerini, temel işlevlerini ve ek araçlarını içerir. Arch Linux sudo pacman -S git [](https://btt.community/t/turkce-git-kullanim-rehberi/25863#p-36820-adm-3-kurulumu-dorulayn-3)Adım 3: Kurulumu Doğrulayın git --version [](https://btt.community/t/turkce-git-kullanim-rehberi/25863#p-36820-adm-4-kullanc-ad-ayarlama-4)Adım 4: Kullanıcı Adı Ayarlama Terminal pencer…
